...
| Dataset | Participants | Statements | Completeness[^completeness] | Fingerprint |
|---------|:------------:|:----------:|:----------------:|:-----------:|
...
[^completeness]: Vote matrix completeness at each quartile of statements (25% / 50% / 75% / 100%), ordered by statement ID. Each value is the % of non-missing votes across all kept participants × the first N statements.
