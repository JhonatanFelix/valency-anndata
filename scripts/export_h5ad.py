...
val.tools.kmeans(adata, mask_obs="cluster_mask", use_rep="X_pacmap", key_added="kmeans_pacmap")
val.tools.kmeans(adata, mask_obs="cluster_mask", use_rep="X_localmap", key_added="kmeans_localmap")
